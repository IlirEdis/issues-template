...
export default function IconCheckSquare(props: IconProps) {
  ...
  return (
    <svg
      ...
      viewBox='0 0 448 512'
    >
      <path d='M339.8 172.2C350.7 183.1 350.7 200.9 339.8 211.8L211.8 339.8C200.9 350.7 183.1 350.7 172.2 339.8L108.2 275.8C97.27 264.9 97.27 247.1 108.2 236.2C119.1 225.3 136.9 225.3 147.8 236.2L192 280.4L300.2 172.2C311.1 161.3 328.9 161.3 339.8 172.2V172.2z' />
      <path
        style={{ opacity: 0.4 }}
